                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                            ...
                            <div className="bg-white p-1 rounded-lg shadow-sm border border-gray-200 flex">
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium transition-colors ${vista === "calendario" ? "bg-indigo-100 text-indigo-700" : "text-gray-600 hover:bg-gray-50"
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium transition-colors ${vista === "lista" ? "bg-indigo-100 text-indigo-700" : "text-gray-600 hover:bg-gray-50"
                                        }`}
                                >
                                    <List size={16} /> Lista
                                </button>
