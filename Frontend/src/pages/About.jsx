...
import ThreeDParticles from "../components/landing/ThreeDParticles";
import { Clock, Users, Globe, ShieldAlert, Zap } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        {/* HERO SECTION REDISEÑADO CON PARTICULAS */}
        <section className="relative w-full h-[60vh] flex items-center justify-center overflow-hidden bg-white">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold text-gray-900 tracking-tight leading-tight mb-4">
              ¿Qué es <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">SIOA</span>?
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                inteligente y libre de estrés. El resultado: un semestre equilibrado donde el estudiante tiene el control.
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-orange-500 hover:shadow-xl transition-shadow">
                ...
                <p className="text-sm text-gray-500 mt-2">Horas perdidas intentando cuadrar secciones.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-gray-600 leading-relaxed mb-8">
            ...
            combinando React, Python y Machine Learning.
          </p>
